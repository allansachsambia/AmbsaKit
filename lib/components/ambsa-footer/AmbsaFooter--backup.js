...
var styles = {
  fadeInUp: {
    animation: "x 1.25s",
    animationName: _radium2.default.keyframes(_reactAnimations.fadeInUp, "fadeInUp")
  }
};
...
var AmbsaFooter = function (_React$Component) {
  ...
  function AmbsaFooter() {
    ...
    var _this = _possibleConstructorReturn(this, (AmbsaFooter.__proto__ || Object.getPrototypeOf(AmbsaFooter)).call(this));

    _this.handleScroll = _this.handleScroll.bind(_this);
    _this.renderStyles = _this.renderStyles.bind(_this);
    _this.state = { thresholdReached: false };
    return _this;
  }
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            "div",
            { className: "inner-wrap", style: this.renderStyles() },
            _react2.default.createElement(
              "div",
